...
## Desafío
1. ¿Qué diferencia hay entre las líneas 7 y 8 de la tabla anterior? GCF representa un ensamblaje de referencia curado por NCBI, mientras que GCA representa ensamblajes primarios enviados directamente por investigadores, es decir, son las secuencias originales, no necesariamente curadas o anotadas.
2. Busca una función de R que te permita identificar las líneas repetidas en un
   marco de datos. Duplicated ()
:::
